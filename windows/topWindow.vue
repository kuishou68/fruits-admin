			...
			<div class="dflex_vertical_c sele_none">
				...
				<el-dropdown class="crpr margin_l_50" @command="handleCommand">
					<div class="dflex_vertical_c">
						<el-image
							class="headimg_mini"
							:src="user.avatar || 'https://mall-os-api.use-cloud.com/files/user/default.png'"
							:preview-src-list="user.avatars"
							fit="cover"
						></el-image>
						<div class="margin_l_10">{{ user.username}}</div>
					</div>
...
export default {
	...
	methods: {
		...
		setUserMsg() {
			...
			this.user.avatars = ['https://mall-os-api.use-cloud.com/files/user/default.png'];
		}
	},
	created() {
		this.setUserMsg();
