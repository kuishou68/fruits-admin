<template>
	<div class="goods_list_add_edit">
		<el-tabs v-model="tab" :before-leave="onTab">
			<el-tab-pane :label="`基本信息`" name="basic"><basic v-if="tab" ref="basic"></basic></el-tab-pane>
			<el-tab-pane :label="`配送信息`" name="detail"><detail v-if="tab" ref="detail" @detail="detail"></detail></el-tab-pane>
			<div class="btn">
