	...
	<div>
		...
		<div class="container member_order use-table">
			...
			>
						...
						<el-form label-position="left" inline>
							<div class="order_detail margin_b_20" v-for="(item, i) in props.row.order_details" :key="i">
								<div class="dflex_vertical_c padding_10">
									<el-image style="width: 90px;" :src="item.goods_img" :preview-src-list="item.imgs" fit="contain"></el-image>
				...
				<el-table-column property="order_total_cnt" label="水果数" align="center"></el-table-column>
				...
				if (index === 3) {
					...
					if (typeof totalMoney === 'number') {
						...
						let timer = setTimeout(() => {
							document.querySelector('.el-table__footer .has-gutter  td:nth-child(4) div').classList.add('price');
