	...
	<div>
		...
		<div class="container margin_b_0">
			...
			<div class="dflex">
				<div>
					...
					<div class="dflex table">
						<div class="table_title padding_l_10 border_top_none">交易账号</div>
						<div class="table_content padding_l_10 border_top_none">
							<div class="dflex_vertical_c pos_a">
								<img class="headimg" :src="orderData.order_member_headimg || '../../../static/user/default.png'" />
					...
					<!-- <div class="dflex table">
						...
						<div class="table_title padding_l_10">水果SKU数量</div>
					...
					<div class="dflex table">
						<div class="table_title padding_l_10">水果数量</div>
		...
		<div class="detail pos_r margin_b_20">
			<el-tabs v-model="tab" @tab-click="cutTabs">
				...
				<el-tab-pane label="水果" name="goods"><goods v-if="tab == 'goods'"></goods></el-tab-pane>
